...
public interface WalletRepository {
     ...
     * 
     * <p>
     * Since each user can have only one wallet, this method
     ...
     * 
     * <p>
     * This method is used for transfer operations where both
    ...
    void saveWithTransaction(Wallet fromWallet, Wallet toWallet,
            Transaction outTransaction, Transaction inTransaction);

    /**
     * Atomically saves a wallet and its associated transaction.
     * 
     * <p>
     * This method ensures that wallet balance updates and transaction
     ...
     * 
     * <p>
     * This method is primarily used for administrative operations
