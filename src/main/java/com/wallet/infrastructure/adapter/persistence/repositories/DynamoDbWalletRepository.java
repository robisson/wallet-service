 ...
 * 
 * <p>This repository provides persistence operations for wallet entities
...
public class DynamoDbWalletRepository implements WalletRepository {
     ...
     */
    public DynamoDbWalletRepository(DynamoDbEnhancedClient enhancedClient, DynamoDbClient dynamoDbClient, WalletMetrics walletMetrics) {
    ...
    @Override
    public void saveWithTransaction(Wallet fromWallet, Wallet toWallet) {
        Timer.Sample sample = walletMetrics.startDatabaseTimer();
        ...
        try {
            ...
            TransactWriteItemsRequest request = TransactWriteItemsRequest.builder()
                .transactItems(Arrays.asList(fromItem, toItem))
                .build();
